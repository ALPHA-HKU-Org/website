  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ position: 'absolute', left: isDarkMode ? 'auto' : '2px', right: isDarkMode ? '2px' : 'auto' }}
      >
        {isDarkMode ? <Moon size={14} className="text-primary" /> : <Sun size={14} className="text-primary" />}
      </motion.div>
    </div>
  );
}