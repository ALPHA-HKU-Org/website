  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] text-center px-4">
      ...
      <p className="text-lg text-muted-foreground max-w-md">
        ...
        In the meantime, you can visit our parent organization at <a href={siteConfig.parentOrg} target="_blank" rel="noopener noreferrer" className="underline">{siteConfig.parentOrg}</a>.
      </p>
    </div>
  );
}
